function [xBout, zNout, nbasout, basout, Bout, Nout,ObjFunc, cN] = funcSimplex3 ( xB, zN,B, N,  nbas, bas,  A, b, c)
B
if any(xB > 0)
    ...
    if any(zN < 0)
        ...
        t = (max(Ratio))^(-1);
        if t<0
            disp(' T The problem is unbounded,since none of these ratios is positive, .')
